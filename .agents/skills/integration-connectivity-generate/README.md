...
| Skill | Integration |
|-------|-------------|
| integration-connectivity-connected-app-configure | Create OAuth Connected App for Named Credential |
| platform-apex-generate | Custom callout services beyond templates |
| automation-flow-generate | HTTP Callout Flow for Agentforce |
| platform-metadata-deploy | Deploy credentials and callout code |
| agentforce-generate | Agent actions using External Services |
